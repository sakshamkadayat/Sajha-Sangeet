...
function Class() {
    const cards = [
        ...
        { title: 'Piano', icon: faMusic, className: 'ClassD', Detail:'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa.' },
    ];
